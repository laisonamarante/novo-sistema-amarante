...
export function Processos() {
  ...
  const etapasList  = trpc.cadastros.etapas.listar.useQuery({})
  const agenciasList = trpc.cadastros.agencias.listar.useQuery({})
  const modalidadesList = trpc.cadastros.modalidades.listar.useQuery()
